...
class _HdphotoWidgetState extends State<HdphotoWidget> {
  ...
  Future<void> _showAdAndProcess() async {
    ...
    if (preferredNetwork == 'applovin') {
      await AppLovinService.showRewardedAd(
        onComplete: () {
          debugPrint('✅ AppLovin ad watched - processing HD image');
          _processHDImage();
        },
        onFailed: () {
      ...
      await AdMobRewardedService.showRewardedAd(
        onComplete: () {
          debugPrint('✅ AdMob ad watched - processing HD image');
          _processHDImage();
        },
        onFailed: () {
  ...
  Future<void> _downloadHDImage() async {
    if (_model.resultImageBase64 == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('No HD image to download')));
      return;
    }
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText('rv5au20w' /* HD Image */),
                              ...
                              Column(
                                ...
                                children: [
                                  Text(
                                    FFLocalizations.of(
                                      context,
                                    ).getText('1nj6ysnn' /* Add Your Photo */),
