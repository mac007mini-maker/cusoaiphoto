...
import 'christmas_download_stub.dart'
    if (dart.library.html) 'christmas_download_web.dart'
    if (dart.library.io) 'christmas_download_mobile.dart';
import 'christmas_model.dart';
export 'christmas_model.dart';

class ChristmasWidget extends StatefulWidget {
  const ChristmasWidget({super.key});

  static String routeName = 'christmas';
  static String routePath = '/christmas';

  @override
  State<ChristmasWidget> createState() => _ChristmasWidgetState();
}

class _ChristmasWidgetState extends State<ChristmasWidget> {
  late ChristmasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChristmasModel());
