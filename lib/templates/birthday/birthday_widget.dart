...
import 'birthday_download_stub.dart'
    if (dart.library.html) 'birthday_download_web.dart'
    if (dart.library.io) 'birthday_download_mobile.dart';
...
class BirthdayWidget extends StatefulWidget {
  ...
  static String routePath = '/birthday';
