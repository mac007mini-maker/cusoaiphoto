...
import 'tattoo_download_stub.dart'
    if (dart.library.html) 'tattoo_download_web.dart'
    if (dart.library.io) 'tattoo_download_mobile.dart';
import 'tattoo_model.dart';
export 'tattoo_model.dart';

class TattooWidget extends StatefulWidget {
  const TattooWidget({super.key});

  static String routeName = 'tattoo';
  static String routePath = '/tattoo';

  @override
  State<TattooWidget> createState() => _TattooWidgetState();
}

class _TattooWidgetState extends State<TattooWidget> {
  late TattooModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TattooModel());
