...
import 'suits_download_stub.dart'
    if (dart.library.html) 'suits_download_web.dart'
    if (dart.library.io) 'suits_download_mobile.dart';
import 'suits_model.dart';
export 'suits_model.dart';

class SuitsWidget extends StatefulWidget {
  const SuitsWidget({super.key});

  static String routeName = 'suits';
  static String routePath = '/suits';

  @override
  State<SuitsWidget> createState() => _SuitsWidgetState();
}

class _SuitsWidgetState extends State<SuitsWidget> {
  late SuitsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SuitsModel());
