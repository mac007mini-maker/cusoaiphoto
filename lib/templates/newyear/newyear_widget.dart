...
import 'newyear_download_stub.dart'
    if (dart.library.html) 'newyear_download_web.dart'
    if (dart.library.io) 'newyear_download_mobile.dart';
import 'newyear_model.dart';
export 'newyear_model.dart';

class NewyearWidget extends StatefulWidget {
  const NewyearWidget({super.key});

  static String routeName = 'newyear';
  static String routePath = '/newyear';

  @override
  State<NewyearWidget> createState() => _NewyearWidgetState();
}

class _NewyearWidgetState extends State<NewyearWidget> {
  late NewyearModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewyearModel());
