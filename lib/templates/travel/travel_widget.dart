...
import 'travel_download_stub.dart'
    if (dart.library.html) 'travel_download_web.dart'
    if (dart.library.io) 'travel_download_mobile.dart';
...
class TravelWidget extends StatefulWidget {
  ...
  static String routePath = '/travel';
