...
import 'fashionshow_download_stub.dart'
    if (dart.library.html) 'fashionshow_download_web.dart'
    if (dart.library.io) 'fashionshow_download_mobile.dart';
import 'fashionshow_model.dart';
export 'fashionshow_model.dart';

class FashionshowWidget extends StatefulWidget {
  const FashionshowWidget({super.key});

  static String routeName = 'fashionshow';
  static String routePath = '/fashionshow';

  @override
  State<FashionshowWidget> createState() => _FashionshowWidgetState();
}

class _FashionshowWidgetState extends State<FashionshowWidget> {
  late FashionshowModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FashionshowModel());
