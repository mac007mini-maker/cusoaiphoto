...
import 'cartoon_toon_model.dart';
export 'cartoon_toon_model.dart';

class CartoonToonWidget extends StatefulWidget {
  const CartoonToonWidget({super.key});

  static String routeName = 'cartoon_toon';
  static String routePath = '/cartoon-toon';

  @override
  State<CartoonToonWidget> createState() => _CartoonToonWidgetState();
}

class _CartoonToonWidgetState extends State<CartoonToonWidget> {
  late CartoonToonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartoonToonModel());
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://$apiDomain/api/ai/cartoon'),
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true && data['url'] != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('✅ Cartoon transformation complete!'),
                    ...
                    children: [
                      ...
                      if (_model.resultImage == null)
                        FFButtonWidget(
                          ...
                          text: _model.isProcessing ? 'Processing...' : 'Transform to Cartoon',
