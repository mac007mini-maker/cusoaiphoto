...
class ArtStyleWidget extends StatefulWidget {
  ...
  static String routeName = 'art_style';
  static String routePath = '/art-style';

  @override
  State<ArtStyleWidget> createState() => _ArtStyleWidgetState();
}
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://$apiDomain/api/ai/art-style'),
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true && data['url'] != null) {
          ...
          debugPrint('⬇️ Downloading art style result from URL...');
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('✅ Art style applied!'),
                    ...
                    children: [
                      ...
                      if (_model.resultImage == null)
                        FFButtonWidget(
                          ...
                          text: _model.isProcessing ? 'Processing...' : 'Apply Art Style',
