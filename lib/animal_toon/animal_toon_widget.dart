...
import 'animal_toon_model.dart';
export 'animal_toon_model.dart';

class AnimalToonWidget extends StatefulWidget {
  const AnimalToonWidget({super.key});

  static String routeName = 'animal_toon';
  static String routePath = '/animal-toon';

  @override
  State<AnimalToonWidget> createState() => _AnimalToonWidgetState();
}

class _AnimalToonWidgetState extends State<AnimalToonWidget> {
  late AnimalToonModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AnimalToonModel());
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://$apiDomain/api/ai/animal-toon'),
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true && data['url'] != null) {
          ...
          debugPrint('⬇️ Downloading animal toon result from URL...');
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('✅ Animal transformation complete!'),
                    ...
                    children: [
                      ...
                      if (_model.resultImage == null)
                        FFButtonWidget(
                          ...
                          text: _model.isProcessing ? 'Processing...' : 'Transform to Animal',
