...
import 'muscle_enhance_model.dart';
export 'muscle_enhance_model.dart';

class MuscleEnhanceWidget extends StatefulWidget {
  const MuscleEnhanceWidget({super.key});

  static String routeName = 'muscle_enhance';
  static String routePath = '/muscle-enhance';

  @override
  State<MuscleEnhanceWidget> createState() => _MuscleEnhanceWidgetState();
}

class _MuscleEnhanceWidgetState extends State<MuscleEnhanceWidget> {
  late MuscleEnhanceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MuscleEnhanceModel());
  ...
  Future<void> _processImage() async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://$apiDomain/api/ai/muscle'),
      ...
      if (response.statusCode == 200) {
        ...
        if (data['success'] == true && data['url'] != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('✅ Muscle enhancement complete!'),
                    ...
                    children: [
                      ...
                      if (_model.resultImage == null)
                        FFButtonWidget(
                          ...
                          text: _model.isProcessing ? 'Processing...' : 'Add Muscles',
