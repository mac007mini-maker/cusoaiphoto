...
class _SettingsWidgetState extends State<SettingsWidget> {
    ...
    return AlertDialog(
      ...
      content: Container(
        ...
        child: ListView.separated(
          ...
          separatorBuilder: (context, index) => Divider(height: 1.0, thickness: 1.0),
  ...
  void _shareApp() async {
    ...
    final String message = '✨ Transform your photos with AI magic! Create stunning AI headshots & avatars with Viso AI 🎨\n\n📸 60+ Professional Styles\n🚀 Studio-Quality Results\n⚡ Fast & Easy to Use\n\nTry it now: $appUrl\n\n#VisoAI #AIHeadshot #AIAvatar';
  ...
  void _sendFeedback() async {
    final Uri emailUri = Uri(
      scheme: 'mailto',
      path: kSupportEmail,
      query: 'subject=Viso AI Feedback&body=Hello Viso AI Team,%0D%0A%0D%0AI would like to give feedback:%0D%0A%0D%0A',
    );
