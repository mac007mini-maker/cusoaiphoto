...
## Recent Changes
- **2025-10-16**: 🐛 **Fixed PiAPI 500 Error**: Stripped data URI prefix (data:image/...;base64,) before sending to PiAPI - API requires raw base64 or plain URLs only. Added error logging for debugging.
